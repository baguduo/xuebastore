...
//                    oneDayWeatherInf.setWeather(weather);
    ...
    public Map<String,String> getWeather(String originLocation) throws Exception{

        Map<String,String> fourDayWeather = new HashMap<>();
        ...
        for(OneDayWeatherInf oneday:one){
            fourDayWeather.put(oneday.getDate(), oneday.getWeather());
            //System.out.println(oneday.toString());
        }
        Set<String> dates = fourDayWeather.keySet();
        for(String date:dates){
            System.out.print(date);
            System.out.println(fourDayWeather.get(date));
        }
